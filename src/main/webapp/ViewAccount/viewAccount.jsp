		...
		<div class="login-form">
			<div class="main-div">
				...
				<div class="panel">
					...
					<p></p>
					<%
					if ((session_obj.message.length() > 0) && session_obj.page_title.equals("view_account")) {
					%>
					<div class="alert-success mt-5 text-center">
						<p><%=session_obj.message%></p>
					</div>
					<%
					}
					%>
				...
				<form method="post" action="view_account">
					...
					<div class="form-group">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<label class="input-group-text" for="transaction_code_view_contact">Transaction
									Type</label>
							</div>
							<select class="custom-select" id="transaction_code_view_contact"
								...
								%>
								<option
									value="<%=transactionTypes.get(i).getTransaction_code()%>"><%=transactionTypes.get(i).getTransaction_code()%></option>
								<%
								}
								%>
							</select>
					...
					<div class="form-group" id = "to_account_viewAcc">
						<label for="to_account" class="float-left">To:</label> <input
							type="number" class="form-control" id="to_account"
							name="to_account" placeholder="Account ID">
					</div>

					<div class="form-group" id="bank_id_viewAcc">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<label class="input-group-text" for="bank_id">Bank</label>
							</div>
					...
					<div class="form-group" id="acc_holder_name">
...
<div class="container">
	<div class="row align-items-center justify-content-center">
		<div class="single-text owl-carousel">
			<div class="slide">
				<p class="text-uppercase text-center" data-aos="fade-up">Last 10
					Statements</p>
	...
	<table class="table table-hover table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<%
				if (transactions.get(i).getFromAccount().getId() == transactions.get(i).getToAccount().getId()) {
				%>
				<th>Self</th>
				<%
				} else {
				...
				<th><%=transactions.get(i).getCreated_at()%></th>
