...
<div class="site-wrap">
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-md-10 mt-lg-5 text-center">
					<div class="single-text owl-carousel">
						<div class="slide">
							<h1 class="text-uppercase" data-aos="fade-up">Welcome to G6
								Bank</h1>
							<p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Our
								bank is providing all the services.</p>
							<div data-aos="fade-up" data-aos-delay="100"></div>
						</div>

						<div class="slide">
							<h1 class="text-uppercase" data-aos="fade-up">Providing
								Different accounts</h1>
							<p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">We
								have All accounts that will simplify your life.</p>
						</div>

						<div class="slide">
							<h1 class="text-uppercase" data-aos="fade-up">Easy
								Transactions</h1>
							<p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Now
								it become easy for making transactions within the accounts.</p>
						</div>
		...
		<div class="container">
			<div class="row mb-5 justify-content-center">
				<div class="col-md-8 text-center">
					<h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">About
						Us</h2>
					<p class="lead" data-aos="fade-up" data-aos-delay="100">The G6
						Bank is the nation's emeriging bank. Its principal role is "to
						promote the economic and financial welfare of Canada.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
					<figure class="circle-bg">
						<img src="static/images/hero_1.jpg"
				...
				<div class="col-lg-5 ml-auto" data-aos="fade-up"
					...
					<p>We continue to learn what matters most to our clients, our
						employees and our shareholders. It helps us start a conversation
						centered on our commitment to use our capabilities to help those
						we serve be successful. Because we recognize that we can only be
						successful when the individuals, companies, communities and
						employees we serve are able to reach their vision of success.</p>
	...
	<section class="site-section border-bottom" id="team-section">
		<div class="container">
			<div class="row mb-5 justify-content-center">
				<div class="col-md-8 text-center">
					<h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Meet
						Team</h2>
					<p class="lead" data-aos="fade-up" data-aos-delay="100">Meet
						our team who are fully dedicated to provide you the best services.</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up"
					...
					<div class="team-member">
						<figure>
							...
							<img src="static/images/pic1.jpeg" alt="Image" class="img-fluid"
				...
				<div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up"
					...
					<div class="team-member">
						<figure>
							...
							<img src="static/images/pic2.jpeg" alt="Image" class="img-fluid"
								width="200px" height="200px">
						</figure>
						<div class="p-3">
							<h3>Dave Simpson</h3>
				...
				<div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up"
					...
					<div class="team-member">
						<figure>
							...
							<img src="static/images/pic3.jpeg" alt="Image" class="img-fluid"
								width="200px" height="200px">
						</figure>
						<div class="p-3">
							<h3>Ben Thompson</h3>
				...
				<div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up"
					...
					<div class="team-member">
						<figure>
							...
							<img src="static/images/pic4.jpeg" alt="Image" class="img-fluid"
								width="200px" height="200px">
						</figure>
						<div class="p-3">
							<h3>Chris Stewart</h3>
		...
		<div class="container">
			...
			<div class="row align-items-stretch">
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
					<div class="unit-4">
						<div class="unit-4-icon">
							<img src="static/images/flaticon-svg/svg/001-wallet.svg"
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4">
						<div class="unit-4-icon">
							<img src="static/images/flaticon-svg/svg/006-credit-card.svg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid w-25 mb-4">
						</div>
						<div>
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4">
						<div class="unit-4-icon">
							<img src="static/images/flaticon-svg/svg/002-rich.svg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid w-25 mb-4">
						</div>
						<div>
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4">
						<div class="unit-4-icon">
							<img src="static/images/flaticon-svg/svg/003-notes.svg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid w-25 mb-4">
						</div>
						<div>
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4">
						<div class="unit-4-icon">
							<img src="static/images/flaticon-svg/svg/004-cart.svg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid w-25 mb-4">
						</div>
						<div>
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4">
						<div class="unit-4-icon">
							<img src="static/images/flaticon-svg/svg/005-megaphone.svg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid w-25 mb-4">
						</div>
						<div>
			...
			<div>
				<div class="testimonial">
					...
					<figure
						...
						<div>
							<img src="static/images/person_3.jpg" alt="Image"
			...
			<div>
				<div class="testimonial">
					...
					<figure
						class="mb-4 d-flex align-items-center justify-content-center">
						<div>
							<img src="static/images/person_4.jpg" alt="Image"
								class="w-50 img-fluid mb-3">
						</div>
						<p>Robert Spears</p>
					</figure>
				...
				<div class="col-md-4 text-center">
					<p class="mb-0">
						<span class="icon-mail_outline d-block h2 text-primary"></span> <a
							href="#">lambtonG6email@java.com</a>
					</p>
				</div>
			</div>
			<div class="row">
