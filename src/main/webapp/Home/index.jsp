      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0">G6 Bank<span class="text-primary">.</span> </a></h1>
          </div>
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-10 mt-lg-5 text-center">
            <div class="single-text owl-carousel">
              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Welcome to G6 Bank</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Our bank is providing all the services.</p>
                <div data-aos="fade-up" data-aos-delay="100">
                </div>
              </div>

              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Providing Different accounts</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">We have All accounts that will simplify your life.</p>
              </div>

              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Easy Transactions</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Now it become easy for making transactions within the accounts.</p>
              </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">The G6 Bank is the nation's emeriging bank. Its principal role is "to promote the economic and financial welfare of Canada.</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>We continue to learn what matters most to our clients, our employees and our shareholders. It helps us start a conversation centered on our commitment to use our capabilities to help those we serve be successful. Because we recognize that we can only be successful when the individuals, companies, communities and employees we serve are able to reach their vision of success.</p>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Meet our team who are fully dedicated to provide you the best services.</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="">
            <div class="team-member">
              <figure>
                ...
                <img src="images/pic1.jpeg" alt="Image" class="img-fluid" width ="200px" height ="200px">
              </figure>
              <div class="p-3">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <figure>
                ...
                <img src="images/pic2.jpeg" alt="Image" class="img-fluid" width ="200px" height ="200px">
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <figure>
                ...
                <img src="images/pic3.jpeg" alt="Image" class="img-fluid" width ="200px" height ="200px">
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
                <span class="position">Bank Teller</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              <figure>
                ...
                <img src="images/pic4.jpeg" alt="Image" class="img-fluid" width ="200px" height ="200px">
              </figure>
              <div class="p-3">
                <h3>Chris Stewart</h3>
                <span class="position">Bank Teller</span>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-0">
              ...
              <a href="#">lambtonG6email@java.com</a>
            </p>
          </div>
        </div>
        <div class="row">
